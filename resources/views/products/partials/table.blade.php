<div class="flex flex-row my-8 items-center justify-between">
    ...
    <div class="items_wrapper flex flex-row justify-between w-full">
        ...
        <div class="filter w-full">
            <button class="text-left text-gray-500 border-gray-500 border-2 outline-none focus:outline-none px-3 py-1 bg-white rounded-sm flex justify-start items-center w-full">
